...
------------------------------------
mar. 14 avril 2020 14:18:14 CEST
Denis Conan
...
- Conception préliminaire
    ...
    - Diagrammes de séquence de cas d'utilisation développés dans la préparation des tests de validation = b+
        - créer une chambre
        - check-in
        - check-out
...
- Utilisation des outils de programmation
    ...
    - Documentation Javadoc et utilisation de Checkstyle = c
...
- Cohérence entre le code et le modèle
    ...
    - Cohérences du code avec les diagrammes de séquence de base = b
        - créer une chambre
        - check-in
        - check-out
        - déclarer la perte d'un badge, sans remplacement
...
modélisation = min(4.0, (3 * 4 / 6) + (3 * 2 / 6) + (1 / 10) - (1 / 10)) = 3.00
programmation, critères majeurs =  (6 * 4 / 8) + (1 * 2 / 8) + (0 / 10) - (0 / 10) = 3.25
programmation, critères mineurs =  (1 * 4 / 8) + (0 * 2 / 8) = .50
programmation = min(4.0, max(3.25 - .50, 0)) = 2.75
projet = 3.00 + 2.75 = 5.75
